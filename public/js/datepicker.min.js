    ...
    var l, c = {
        ...
        p = function(o) {
            ...
            var t, a, n = ((t = document.createElement("div")).className = "mtr-arrow up", t.appendChild(document.createElement("span")),
                ...
                r = ((a = document.createElement("div")).className = "mtr-arrow down",
            ...
            var m, i, u = ((m = document.createElement("input")).value = o.value, m.type = "text",
                    m.className = "mtr-input " + o.name, m.style.display = "none", m.addEventListener("blur", function(n) {
                        setTimeout(function() {
                            ! function() {
                                if (l) {
                                    var e = m.value,
                                        t = m.getAttribute("data-old-value");
                        ...
                        var t, a = e.wheelDeltaY ? e.wheelDeltaY : -1 * e.deltaY,
                            n = parseInt(m.value),
                            r = c[o.name].min,
                            s = c[o.name].max,
                            i = c[o.name].step;
                ...
                d = ((i = b(o)).addEventListener("touchstart", function(e) {
                    var t;
                    ...
                    ! function(e, t) {
                        ...
                        var t = i.parentElement.parentElement,
                            a = J(t, 0 < e ? ".mtr-arrow.up" : ".mtr-arrow.down");
                        a.click();
                    });
                }, !1), i);
            ...
            return i.addEventListener("click", e, !1), i.addEventListener("touchstart", e, !1),
                i.addEventListener("touchend", e, !1), i.addEventListener("wheel", function(e) {
                    ...
                    var t = e.target.parentElement.parentElement.parentElement.parentElement,
                        a = J(t, 0 < (e.wheelDeltaY ? e.wheelDeltaY : -1 * e.deltaY) ? ".mtr-arrow.up" : ".mtr-arrow.down");
