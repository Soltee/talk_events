...
<div class="">
	...
	<!-- Add User Icon -->
	@can('add speakers')
		<a href="{{ route('speaker.create') }}" class="z-10 fixed right-0 bottom-0 mr-32 mb-32  text-xl font-3xl text-white bg-blue-600 rounded-full px-6 py-5  hover:opacity-75 z-10">+</a>
	@endcan
