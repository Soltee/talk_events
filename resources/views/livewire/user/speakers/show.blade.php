...
<div>
	<div class="flex items-center mb-4">
	    ...
	    <a href="/speaker" class="text-sm md:text-md font-thin hover:font-semibold text-c-pink opacity-75">Speakers</a>

	    <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 mr-2 text-c-light-gray" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
	    <h4 class="text-sm md:text-md font-bold text-c-pink opacity-75">{{ $speaker->first_name . ' ' . $speaker->last_name }}</h4>
	</div>


    <div class="mt-3 flex flex-col ">
    	<div class="mb-4 flex flex-col sm:flex-row">
    		<img  class="w-full sm:w-64 bg-cover bg-center mb-5 rounded-lg " src="{{ asset($speaker->avatar) }}" alt="" onerror="this.src='https://via.placeholder.com/300'">
