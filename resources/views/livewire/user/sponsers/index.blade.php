...
<div class="w-full">
	<div class="flex justify-between items-center mb-4">
		<div class="flex items-center">
		    ...
		    <a class="text-sm md:text-md font-bold opacity-75">Sponsers</a>
		</div>
			...
			@forelse($sponsers as $sponser)
				<div class="flex flex-col  items-center mb-6 plain-item  items-center
        			...
        			<div class="mt-3 w-full  flex flex-col items-start justify-between">
	        			...
	        			<a  href="{{ url('sponsers', $sponser->id . '-' . $sponser->full_name )}}" class="text-blue-600 font-semibold hover:opacity-75">
