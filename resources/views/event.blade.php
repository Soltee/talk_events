    ...
    <div class="w-full flex flex-col  px-6 md:px-24  lg:px-40  my-8">
    	...
    	<div class="flex justify-between items-center">
			<div class="flex items-center mb-4 ">
	    		...
	    		<svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 mr-2 text-c-light-gray" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
	    		<h4 class="text-md font-light text-gray-800 opacity-75">{{ $event->name }}</h4>
		    </div>
		    <a href="{{ url('events/' . $event->id . '-' . $event->slug()) . "/checkout" }}">
		    	<button type="submit" class="text-white bg-blue-600 hover:bg-blue-500 px-6 py-3 rounded-lg">Book Now</button>
		    </a>
		</div>
