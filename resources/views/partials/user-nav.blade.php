<div class="flex items-center justify-between ">
	<div class="flex items-center ">
		...
		@if(Route::currentRouteName() == 'profile')
			...
			<a href="/profile" class="text-gray-900 text-lg capitalize text-md md:text-lg md:text-lg   {{ Route::currentRouteName() === 'profile' ? 'font-semibold' : 'text-blue-500 hover:font-semibold ' }}">Profile</a>
		@endif
