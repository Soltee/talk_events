    ...
    <div class="absolute  bg-white left-0 right-0  mx-auto  max-w-xl shadow-lg rounded-lg p-6 z-30">
    	...
    	@if(session('done'))
    		<div class="flex flex-col items-center">
				...
				<p class=" bg-green-200 rounded  px-6 py-3 text-green-600">{{session('done')}}</p>
    		</div>
	 	@else
	        <div class="text-right">
	            <button x-on:click="" type="button" class=" cursor-pointer" data-dismiss="modal" aria-label="Close">
	        ...
	        <div class="">
	            ...
	            <div class="mt-6 mb-3 flex justify-end">
	                <button x-on:click="open = false;" class="cursor-pointer text-gray-900 px-4 py-3 rounded-lg mr-4">Cancel</button>
	                <button wire:click="drop" class="cursor-pointer bg-red-600 hover:bg-red-500 text-white px-4 py-3 rounded-lg">Delete</button>
	            </div>
	        </div>
        @endif
